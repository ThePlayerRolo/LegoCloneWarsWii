...
#define DSP_CODE_WORK_MEM_BACKUP ((u8*)OSGetMEM1ArenaHi() - sizeof(DSPInitCode))
...
inline static void waitMicroSec(u32 usec) {
    u32 start = OSGetTick();
    do {
        ;
