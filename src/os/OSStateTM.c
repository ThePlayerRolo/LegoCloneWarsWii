...
inline static void __OSRegisterStateEvent(void);
inline static void __OSDefaultResetCallback(void);
inline static void __OSDefaultPowerCallback(void);
static s32 __OSStateEventHandler(s32 result, void* arg);
static void LockUp(void);

inline OSStateCallback OSSetResetCallback(OSStateCallback callback) {
    BOOL enabled;
    OSStateCallback old;
...
inline BOOL __OSGetResetButtonStateRaw(void) {
...
inline s32 __OSSetIdleLEDMode(u32 mode) {
#define in_args ((u32*)StmImInBuf)
